...
.PHONY: dev dev-postgres dev-distributed smoke-distributed compose-app compose-app-stop website website-postgres frontend backend worker postgres postgres-stop demo seed-job-monitors test
